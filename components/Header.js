...
const products = [
  ...
  { name: 'Get baptized', description: 'The first step in obedience after you get saved to profess your faith and begin your walk with God', href: '#', icon: UserIcon },
      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div className="flex lg:flex-1">
          <a href="#" className="-m-1.5 p-1.5">
            ...
            <img className="h-8 w-auto" src="https://www.svgrepo.com/show/194193/bible.svg" alt="" />
          </a>
        </div>
